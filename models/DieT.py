...
def deit_small_patch16_224(pretrained=False, **kwargs):
    ...
    if pretrained:
        ckpt = torch.load('/home/hashmat.malik/Fall 2021/CV703 Lab/Week5/models/deit_small_patch16_224-cd65a155.pth')
    ...
    #pe = F.interpolate(pe, size=(12, 16), mode='bilinear', align_corners=True)       No idea what's happening
    pe = pe.flatten(2)
    pe = pe.transpose(-1, -2)
